...
书蕴笔记系列索引在这里：[书蕴——基于书评的人工智能推荐系统](/项目记录/2018/01/书蕴——基于书评的人工智能推荐系统/)
...
这里每一项都是[上一篇文章](/项目记录/2018/02/书蕴笔记-2-使用word2vec模型迭代获取标签/)的思路下计算得到的标签集合
...
>[题外话]我使用gensim的word2vec训练维基百科语料库的内容在 [[书蕴笔记-1]word2vec模型训练](/项目记录/2018/01/书蕴笔记-1-word2vec模型训练/)) 中有过提及，参考资料也不少,欢迎查看
### 结合例子
